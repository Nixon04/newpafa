...
var $e = async (r4, e, t) => {
  ...
  let i = new TextEncoder(), s = JSON.stringify(t), o = new Uint8Array(s.length * 3), p = i.encodeInto(s, o);
  return window.crypto.subtle.encrypt({ name: "AES-GCM", iv: r4 }, e, o.subarray(0, p.written));
};
var Be = async (r4, e, t) => {
...
function qe(r4, e, t, i = "brackets") {
  let s = /^[a-z][a-z0-9+.-]*:\/\//i.test(e.toString()), o = s || e.toString().startsWith("/"), p = !o && !e.toString().startsWith("#") && !e.toString().startsWith("?"), u = e.toString().includes("?") || r4 === "get" && Object.keys(t).length, d = e.toString().includes("#"), c = new URL(e.toString(), "http://localhost");
  ...
  }), { encodeValuesOnly: true, arrayFormat: i }), t = {}), [[s ? `${c.protocol}//${c.host}` : "", o ? c.pathname : "", p ? c.pathname.substring(1) : "", u ? c.search : "", d ? c.hash : ""].join(""), t];
}
function F(r4) {
...
var re = class {
  ...
  set(e, { replace: t = false, preserveScroll: i = false, preserveState: s = false } = {}) {
    ...
    return e.clearHistory && a.clear(), this.resolve(e.component).then((p) => {
      if (o !== this.componentId) return;
      e.rememberedState ?? (e.rememberedState = {});
      let u = typeof window < "u" ? window.location : new URL(e.url);
      return t = t || L(y(e.url), u), new Promise((d) => {
        t ? a.replaceState(e, () => d(null)) : a.pushState(e, () => d(null));
      }).then(() => {
        let d = !this.isTheSame(e);
        return this.page = e, this.cleared = false, d && this.fireEventsFor("newComponent"), this.isFirstPageLoad && this.fireEventsFor("firstLoad"), this.isFirstPageLoad = false, this.swap({ component: p, page: e, preserveState: s }).then(() => {
...
var ce = class {
  ...
  add(e, t, { cacheFor: i }) {
    ...
    let [p, u] = this.extractStaleValues(i), d = new Promise((c, l) => {
      t({ ...e, onCancel: () => {
    ...
    }).then((c) => (this.remove(e), this.cached.push({ params: { ...e }, staleTimestamp: Date.now() + p, response: d, singleUse: i === 0, timestamp: Date.now(), inFlight: false }), this.scheduleForRemoval(e, u), this.inFlightRequests = this.inFlightRequests.filter((l) => !this.paramsAreEqual(l.params, e)), c.handlePrefetch(), c));
  ...
  paramsAreEqual(e, t) {
    return ae(this.withoutPurposePrefetchHeader(e), this.withoutPurposePrefetchHeader(t), ["showProgress", "replace", "prefetch", "onBefore", "onStart", "onProgress", "onFinish", "onCancel", "onSuccess", "onError", "onPrefetched", "onCancelToken", "onPrefetching", "async"]);
  }
};
var x = new ce();
var j = class r {
...
var U = class r2 {
  ...
  mergeProps(e) {
    ...
    t.forEach((s) => {
      ...
      let o = e.props[s], p = n.get().props[s], u = (d, c) => Array.isArray(c) ? [...Array.isArray(d) ? d : [], ...c] : typeof c == "object" && c !== null ? Object.keys(c).reduce((l, h3) => (l[h3] = u(d ? d[h3] : void 0, c[h3]), l), { ...d }) : c;
      e.props[s] = u(p, o);
...
var W = class {
  ...
  visit(e, t = {}) {
    ...
    let p = { ...i, ...s }, u = x.get(p);
    u ? (X(u.inFlight), x.use(u, p)) : (X(true), o.send(H.create(p, n.get())));
  }
  getCached(e, t = {}) {
  ...
  prefetch(e, t = {}, { cacheFor: i = 3e4 }) {
    ...
    let s = this.getPendingVisit(e, { ...t, async: true, showProgress: false, prefetch: true }), o = s.url.origin + s.url.pathname + s.url.search, p = window.location.origin + window.location.pathname + window.location.search;
    if (o === p) return;
    let u = this.getVisitEvents(t);
    if (u.onBefore(s) === false || !Y(s)) return;
    ...
    new Promise((l) => {
      ...
      x.add(d, (l) => {
        this.asyncRequestStream.send(H.create(l, n.get()));
      }, { cacheFor: i });
    });
  }
  clearHistory() {
...
function Ie(r4, e, t) {
  ...
  return c(), { forceUpdate: c, createProvider: function() {
    let l = o();
    return { update: (h3) => u(l, h3), disconnect: () => p(l) };
  } };
}
var f = "nprogress";
var P;
...
var q = null;
var Ye = (r4) => {
  Object.assign(g, r4), g.includeCSS && st(g.color), P = document.createElement("div"), P.id = f, P.innerHTML = g.template;
};
var z = (r4) => {
  let e = Le();
  r4 = De(r4, g.minimum, 1), q = r4 === 1 ? null : r4;
  let t = et(!e), i = t.querySelector(g.barSelector), s = g.speed, o = g.easing;
  t.offsetWidth, it((p) => {
    let u = g.positionUsing === "translate3d" ? { transition: `all ${s}ms ${o}`, transform: `translate3d(${Q(r4)}%,0,0)` } : g.positionUsing === "translate" ? { transition: `all ${s}ms ${o}`, transform: `translate(${Q(r4)}%,0)` } : { marginLeft: `${Q(r4)}%` };
    for (let d in u) i.style[d] = u[d];
    if (r4 !== 1) return setTimeout(p, s);
    t.style.transition = "none", t.style.opacity = "1", t.offsetWidth, setTimeout(() => {
      t.style.transition = `all ${s}ms linear`, t.style.opacity = "0", setTimeout(() => {
        He(), t.style.transition = "", t.style.opacity = "", p();
      }, s);
    }, s);
  });
};
...
var et = (r4) => {
  var _a;
  if (tt()) return document.getElementById(f);
...
var Ue = () => rt(g.parent) ? g.parent : document.querySelector(g.parent);
var He = () => {
  document.documentElement.classList.remove(`${f}-busy`), Ue().classList.remove(`${f}-custom-parent`), P == null ? void 0 : P.remove();
};
var tt = () => document.getElementById(f) !== null;
var rt = (r4) => typeof HTMLElement == "object" ? r4 instanceof HTMLElement : r4 && typeof r4 == "object" && r4.nodeType === 1 && typeof r4.nodeName == "string";
function De(r4, e, t) {
...
var b = { configure: Ye, isStarted: Le, done: Ze, set: z, remove: He, start: ke, status: q, show: nt, hide: ot };
var _ = 0;
var X = (r4 = false) => {
...
function at2(r4) {
  document.addEventListener("inertia:start", (e) => lt(e, r4)), document.addEventListener("inertia:progress", ct);
}
function lt(r4, e) {
  r4.detail.visit.showProgress || J();
  let t = setTimeout(() => b.start(), e);
  document.addEventListener("inertia:finish", (i) => ut(i, t), { once: true });
}
function ct(r4) {
  var _a;
...
function Me({ delay: r4 = 250, color: e = "#29d", includeCSS: t = true, showSpinner: i = false } = {}) {
  at2(r4), b.configure({ showSpinner: i, includeCSS: t, color: e });
}
function Ne(r4) {
...
function x2(e, r4) {
  let n2 = typeof e == "string" ? e : null, s = (typeof e == "string" ? r4 : e) ?? {}, o = n2 ? Jr.restore(n2) : null, a2 = typeof s == "function" ? cloneDeep(s()) : cloneDeep(s), l = null, f2 = null, m2 = (t) => t, v2 = reactive({ ...o ? o.data : cloneDeep(a2), isDirty: false, errors: o ? o.errors : {}, hasErrors: false, processing: false, progress: null, wasSuccessful: false, recentlySuccessful: false, data() {
    ...
    d === "delete" ? Jr.delete(p, { ...T2, data: F2 }) : Jr[d](p, F2, T2);
  }, get(t, i) {
    this.submit("get", t, i);
  }, post(t, i) {
...
var ie2 = defineComponent({ name: "Inertia", props: { initialPage: { type: Object, required: true }, initialComponent: { type: Object, required: false }, resolveComponent: { type: Function, required: false }, titleCallback: { type: Function, required: false, default: (e) => e }, onHeadUpdate: { type: Function, required: false, default: () => () => {
  ...
  return E2 = Ie(a2, s, o), a2 || (Jr.init({ initialPage: e, resolveComponent: n2, swapComponent: async (l) => {
    y2.value = markRaw(l.component), h2.value = l.page, A2.value = l.preserveState ? A2.value : Date.now();
  } }), Jr.on("navigate", () => E2.forceUpdate())), () => {
    if (y2.value) {
...
var B2 = ie2;
var q2 = { install(e) {
  Jr.form = x2, Object.defineProperty(e.config.globalProperties, "$inertia", { get: () => Jr }), Object.defineProperty(e.config.globalProperties, "$page", { get: () => h2.value }), Object.defineProperty(e.config.globalProperties, "$headManager", { get: () => E2 }), e.mixin(V2);
} };
function ae2() {
