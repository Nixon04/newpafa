...
export const useListStore = defineStore('all_lists', () => {
  ...
  const switchlanguage = ref(localStorage.getItem('switchlanguage') === 'true'); // false = English, true = French
  ...
  const translations = {
    en: {
      firstquestions: [
        { id: 1, name: 'Myself' },
        { id: 2, name: 'My Child' },
        { id: 3, name: 'A family member' },
      ],
      secondquestion: [
        { id: 1, name: 'I want my child to learn faster and do better in school' },
        { id: 2, name: 'I have a child with special needs and want to support their learning' },
        { id: 3, name: 'I want to sharpen my mind and think faster' },
        { id: 4, name: 'I want to improve creativity and problem-solving' },
      ],
      thirdquestion: [
        { id: 1, name: 'Yes, a lot' },
        { id: 2, name: 'Sometimes' },
        { id: 3, name: 'No, not really' },
      ],
      forthquestion: [
      ...
      fifthquestion: [
        { id: 1, name: 'Yes, I love it!' },
        { id: 2, name: 'A little, but not seriously' },
        { id: 3, name: 'No, but I’m open to learning' },
        { id: 4, name: 'No, and I don’t think I’m good at it' },
      ],
      sixquestion: [
        { id: 1, name: 'Yes, definitely!' },
    ...
    fr: {
      firstquestions: [
        { id: 1, name: 'Moi-même' },
        { id: 2, name: 'Mon enfant' },
        { id: 3, name: 'Un membre de la famille' },
      ],
      secondquestion: [
        { id: 1, name: "Je veux que mon enfant apprenne plus vite et réussisse à l'école" },
        { id: 2, name: "J'ai un enfant ayant des besoins spéciaux et je veux soutenir son apprentissage" },
        { id: 3, name: "Je veux affûter mon esprit et penser plus rapidement" },
        { id: 4, name: "Je veux améliorer ma créativité et ma résolution de problèmes" },
      ],
      thirdquestion: [
        { id: 1, name: 'Oui, beaucoup' },
        { id: 2, name: 'Parfois' },
        { id: 3, name: 'Non, pas vraiment' },
      ],
      forthquestion: [
        { id: 1, name: 'Très important' },
        { id: 2, name: 'Important' },
        { id: 3, name: 'Pas sûr' },
      ],
      fifthquestion: [
        { id: 1, name: "Oui, j'adore ça !" },
        { id: 2, name: 'Un peu, mais pas sérieusement' },
        { id: 3, name: "Non, mais je suis prêt à apprendre" },
        { id: 4, name: "Non, et je ne pense pas être doué" },
      ],
      sixquestion: [
        { id: 1, name: 'Oui, absolument !' },
  ...
  const lang = computed(() => (switchlanguage.value ? 'fr' : 'en'));
  const firstquestions = computed(() => translations[lang.value].firstquestions);
  const secondquestion = computed(() => translations[lang.value].secondquestion);
  const thirdquestion = computed(() => translations[lang.value].thirdquestion);
  ...
  function updateAnswer() {
    ...
    console.log('Updated answers: ', number.value);
  }
  ...
  const submit = async () => {
    ...
    if ((answers.value[0] === 'My Child' || answers.value[0] === 'A family member' || answers.value[0] === 'Mon enfant' || answers.value[0] === 'Un membre de la famille') && !userdetails.members) {
